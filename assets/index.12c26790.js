...
`;function Lt(){var e,t,i,a,n,r,l,o;const[d,h]=c.exports.useState(),[u,g]=c.exports.useState(null),[b,f]=c.exports.useState(null),[v,y]=c.exports.useState(!1),[w,_]=c.exports.useState(!1),[k,S]=c.exports.useState(!1),[C,T]=c.exports.useState([]),[A,P]=c.exports.useState([]),[R,O]=c.exports.useState([]),[E,z]=c.exports.useState(),[H,I]=c.exports.useState(),[L,j]=c.exports.useState(),{register:V,handleSubmit:U,formState:{errors:q}}=se({resolver:oe(yt)});c.exports.useEffect((()=>{B()}),[]);let B=async()=>{let{data:e}=await m.get(`${{}.REACT_APP_HOST_URL}/api_public/list/city`);T(e.data)};c.exports.useEffect((()=>{F()}),[E]);let F=async()=>{let e=E,{data:t}=await m.post(`${{}.REACT_APP_HOST_URL}/api_public/list/province`,{quan:e},{headers:{"Content-type":"application/json"}});P(t.result[0].areas)};c.exports.useEffect((()=>{M()}),[H]);let M=async()=>{let e=H,{data:t}=await m.post(`${{}.REACT_APP_HOST_URL}/api_public/list/province`,{quan:e},{headers:{"Content-type":"application/json"}});O(t.result[0].areas)};return k?p(D,{to:"/signin"}):p(N,{children:x(wt,{children:[p(_t,{children:p(kt,{children:"Đăng kí"})}),x("div",{children:[v&&p(lt,{variant:"danger",children:v}),w&&p(rt,{})]}),p(St,{onSubmit:U((async e=>{if(null==d)g("Vui lòng chọn giới Tính");else if(null!=d||null!=H&&null!=E&&null!=L)if(null==H||null==E||null==L)f("Vui lòng chọn thông tin địa chỉ của bạn");else{console.log("trim:",e),g(null),f(null);let t=e.username.replace(/\s/g,""),i=e.password.replace(/\s/g,""),a=e.phone,n=e.address,r=e.email,l=e.first+" "+e.last;const s={headers:{"Content-type":"application/json"}};_(!0);const o=await m.post(`${{}.REACT_APP_HOST_URL}/api_public/list/register`,{user_name:t,password:i,phone_number:a,address_des:n,email:r,district:H,province:L,gender:d,full_name:l},s);200==o.data.statusCode?(S(!0),_(!1)):(_(!1),y(o.data.message))}else g("Vui lòng chọn giới Tính"),f("Vui lòng chọn thông tin địa chỉ của bạn")})),children:x(Ct,{children:[x(Tt,{children:[p(At,{placeholder:"Anh",type:"radio",name:"gender",onChange:e=>h(!0)}),"Anh",p(At,{placeholder:"Chị",type:"radio",name:"gender",onChange:e=>h(!1)}),"Chị"]}),u&&p(Ht,{children:u}),p(Tt,{children:p(Pt,s({id:"họ",placeholder:"Họ",type:"text",name:"first"},V("first")))}),q.first&&p(Ht,{children:null==(e=q.first)?void 0:e.message}),p(Tt,{children:p(Pt,s({id:"tên",placeholder:"Tên",type:"text",name:"last"},V("last")))}),q.last&&p(Ht,{children:null==(t=q.last)?void 0:t.message}),x(Tt,{children:[p(Pt,s({id:"username",placeholder:"Tên đăng nhập",type:"text",name:"username"},V("username"))),q.username&&p(Ht,{children:null==(i=q.username)?void 0:i.message})]}),x(Tt,{children:[p(Pt,s({id:"phone",placeholder:"Số điện thoại",type:"text",name:"phone"},V("phone"))),q.phone&&p(Ht,{children:null==(a=q.phone)?void 0:a.message})]}),x(Tt,{children:[p(Pt,s({id:"address",placeholder:"Địa chỉ",type:"text",name:"address"},V("address"))),q.address&&p(Ht,{children:null==(n=q.address)?void 0:n.message})]}),x(Tt,{children:[p(Pt,s({id:"email",placeholder:"Email",type:"text",name:"email"},V("email"))),q.email&&p(Ht,{children:null==(r=q.email)?void 0:r.message})]}),b&&p(Ht,{children:b}),p(Tt,{children:p(It,{onChange:e=>{const t=e.target.selectedIndex,i=e.target.childNodes[t].getAttribute("id");z(i)},children:null==C?void 0:C.map(((e,t)=>x(N,{children:[p("option",{value:" ",hidden:!0,children:"Thành phố"}),x("option",{id:e.uid,children:[e.name," "]})]})))})}),p(Tt,{children:E?p(It,{onChange:e=>{const t=e.target.selectedIndex,i=e.target.childNodes[t].getAttribute("id");I(i)},children:null==A?void 0:A.map(((e,t)=>x(N,{children:[p("option",{value:" ",hidden:!0,children:"Quận"}),x("option",{id:e.uid,children:[e.name," "]})]})))}):p(N,{})}),p(Tt,{children:H?p(It,{onChange:e=>{const t=e.target.selectedIndex,i=e.target.childNodes[t].getAttribute("id");j(i)},children:null==R?void 0:R.map(((e,t)=>x(N,{children:[p("option",{value:" ",hidden:!0,children:"Phường"}),x("option",{id:e.uid,children:[e.name," "]})]})))}):p(N,{})}),x(Tt,{children:[p(Pt,s({id:"password",placeholder:"Mật khẩu",type:"password",name:"password"},V("password"))),q.password&&p(Ht,{children:null==(l=q.password)?void 0:l.message})]}),x(Tt,{children:[p(Pt,s({id:"confirm_password",placeholder:"Nhập lại mật khẩu",type:"password",name:"confirm_password"},V("confirm_password"))),q.confirm_password&&p(Ht,{children:null==(o=q.confirm_password)?void 0:o.message})]}),p(Tt,{children:p(Rt,{type:"submit",children:"Đăng kí "})}),p(Tt,{children:x(Et,{children:[p("li",{children:p(zt,{children:" hoặc "})}),p("li",{children:p("a",{href:"/signin",children:p(Ot,{children:"Đăng nhập nếu đã có tài khoản"})})})]})})]})})]})})}const jt=re().shape({phone:le().required("Vui lòng nhập số điện thoại").matches(/^((\\+[1-9]{1,4}[ \\-]*)|(\\([0-9]{2,3}\\)[ \\-]*)|([0-9]{2,4})[ \\-]*)*?[0-9]{3,4}?[ \\-]*[0-9]{3,4}?$/,"Số điện thoại không phù hợp").min(10,"Số điện thoại tối thiểu 10 ký tự"),password:le().trim().required("Vui lòng nhập mật khẩu").min(6,"Mật khẩu tối thiểu 6 ký tự"),confirm_password:le().trim().required("Vui lòng nhập mật khẩu").min(6,"Mật khẩu tối thiểu 6 ký tự").oneOf([de("password")],"Mật khẩu không trùng khớp ")}),Vt=U.div`
  overflow: hidden;
  padding: 0 0 32px;
  margin: 48px auto 0;
  width: 500px;
